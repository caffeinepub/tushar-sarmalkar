...
export class Backend implements backendInterface {
    ...
    async getAllByEmail(): Promise<Array<ContactMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllByEmail();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllByName(): Promise<Array<ContactMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllByName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
